-- Stage 1 credit-card expansion
-- Keep the bridge explicit: add only image-ready BPI/Petron BPI rows while
-- preserving the original `publicly_available` public set.
