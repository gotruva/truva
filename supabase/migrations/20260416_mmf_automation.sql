...
create table if not exists public.mmf_daily_rates (
  ...
  date date not null,
  navpu numeric(18,6),
  gross_yield_1y numeric(9,6),
  after_tax_yield numeric(9,6),
  net_yield numeric(9,6),
  benchmark_rate numeric(9,6),
  vs_benchmark numeric(9,6),
...
('atram-peso-money-market-fund', 'ATRAM Peso Money Market Fund', 'ATRAM Trust Corporation', 'UITF', 'PHP', 0.0045, 50, 50, 1, 0, null, '91-day T-Bill (BTr)', 'BTR_91D', 'Conservative', false, array['GCash', 'Maya', 'Seedbox', 'Branch'], 'https://www.atram.com.ph/funds/uitf-funds/details?fund=ATRPHMM', null, 'uitf_com_ph', null, 189, true),
...
('alfm-money-market-fund-shares', 'ALFM Money Market Fund (Shares)', 'BPI Wealth', 'Mutual Fund', 'PHP', 0.0050, 1000, null, 0, 7, '1% within 7 calendar days', 'BPI Money Market Index', 'BTR_91D', 'Conservative', false, array['BPI Online', 'COL Financial', 'FundsMart', 'Branch'], 'https://www.bpi.com.ph/group/bpiwealth/our-solutions/personal/investment-solutions/funds/alfm-money-market-fund-shares', null, 'bank_website', 'https://pifa.com.ph/facts-figures/nav-history/?fund_id=69', null, true),
('alfm-money-market-fund-units', 'ALFM Money Market Fund (Units)', 'BPI Wealth', 'Mutual Fund', 'PHP', 0.0050, 1000, null, 0, 7, '1% within 7 calendar days', 'BPI Money Market Index', 'BTR_91D', 'Conservative', false, array['Maya Funds', 'Investa', 'COL Financial', 'FundsMart', 'BPI Online'], 'https://www.bpi.com.ph/wealth/assetandwealth/our-solutions/personal/investment-solutions/funds/alfm-money-market-fund-units', null, 'bank_website', 'https://pifa.com.ph/facts-figures/nav-history/?fund_id=120', null, true),
