-- Normalize public cash-advance percentage units.
-- Some source rows store percent values as basis points (300 = 3.00%).
-- Keep raw web_weaver data unchanged and normalize only the public bridge.
