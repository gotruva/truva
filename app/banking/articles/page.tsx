...
export const metadata: Metadata = {
  title: 'Savings & Deposits Articles & Guides | Truva',
  description:
    'Rate guides, bank reviews, and head-to-head comparisons. Everything a Filipino saver needs to make a sharper savings decision.',
  alternates: {
      ...
      <section className="bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 py-10 px-4 sm:py-16 sm:px-6">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl lg:text-5xl">
            ...
            <span className="block sm:inline">Philippine savings and deposits.</span>
          </h1>
          <p className="mt-4 max-w-xl text-base leading-relaxed text-blue-100/70">
            Rate guides, bank reviews, and head-to-head comparisons - so your next savings decision is the right one.
          </p>
        </div>
      </section>
      ...
      <div className="bg-brand-surface dark:bg-slate-950 py-12">
        <div className="mx-auto max-w-5xl px-4 sm:px-6">
          <ArticleHubClient
            ...
            searchPlaceholder="Search savings articles..."
          />
        </div>
      </div>
    </div>
