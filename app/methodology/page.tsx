  ...
  return (
    <div className="max-w-4xl mx-auto py-16 px-4">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <p>
          Truva is an independent platform built by a solo founder. While we may earn a referral commission if you open an account through our links, our comparison engines, calculators, and rankings are hard-coded to be driven exclusively by math, public rates, and terms—not by highest-paying affiliates.
        </p>
