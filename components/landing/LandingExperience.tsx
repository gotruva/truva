...
function buildCategories({
  ...
  return [
    ...
    },
    {
      ...
      href: creditCardSummary.hasLiveData ? '/credit-cards' : '#truva-brief',
      cta: creditCardSummary.hasLiveData ? 'Compare cards' : 'Get updates',
      statusLabel: creditCardSummary.hasLiveData ? 'Live' : 'Coming soon',
      statusTone: creditCardSummary.hasLiveData ? 'live' : 'soon',
      icon: CreditCard,
