...
const PROVIDER_DEFINITIONS: RateProviderDefinition[] = [
  ...
  },
  {
    ...
    publishAllowed: true,
    sources: [
      { kind: 'landing_page', url: 'https://salmon.ph/', parseStrategy: 'html' },
    ],
  },
  {
    ...
    publishAllowed: true,
    sources: [
      { kind: 'landing_page', url: 'https://netbank.ph/', parseStrategy: 'html' },
    ],
  },
  {
    ...
    publishAllowed: true,
    sources: [
      { kind: 'landing_page', url: 'https://www.komo.ph/', parseStrategy: 'html' },
    ],
  },
  {
    ...
    publishAllowed: true,
    sources: [
      { kind: 'landing_page', url: 'https://diskartech.ph/', parseStrategy: 'html' },
    ],
  },
  {
    ...
    publishAllowed: true,
    sources: [
      { kind: 'landing_page', url: 'https://www.ownbank.com/', parseStrategy: 'html' },
    ],
  },
  {
    ...
    publishAllowed: true,
    sources: [
      { kind: 'landing_page', url: 'https://www.landbank.com/', parseStrategy: 'html' },
    ],
  },
  {
    institutionSlug: 'dbp',
    ...
    publishAllowed: true,
    sources: [
      { kind: 'landing_page', url: 'https://www.dbp.ph/', parseStrategy: 'html' },
    ],
  },
  {
  ...
  },
  {
    ...
    automationPhase: 'manual_seed',
    defaultSourceMode: 'manual_annual',
    publishAllowed: true,
    sources: [
      { kind: 'landing_page', url: 'https://www.pagibigfund.gov.ph/', parseStrategy: 'html' },
    ],
  },
  {
