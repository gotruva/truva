...
export const CREDIT_CARD_VISUAL_ASSETS = [
  ...
  {
    cardKeys: ['eastwest dolce vita titanium mastercard', 'eastwest_dolce_vita_titanium_mastercard'],
    assetPath: '/cards/clean/eastwest_dolce_vita_titanium_mastercard.webp',
    sourceUrl: 'https://www.eastwestbanker.com/cards/creditcards/dolce-vita-titanium-mastercard',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['eastwest krisflyer world mastercard', 'eastwest_krisflyer_world_mastercard'],
    assetPath: '/cards/clean/eastwest_krisflyer_world_mastercard.webp',
    sourceUrl: 'https://www.eastwestbanker.com/cards/creditcards/krisflyer-world-mastercard',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['eastwest priority visa infinite', 'eastwest_priority_visa_infinite'],
    assetPath: '/cards/clean/eastwest_priority_visa_infinite.webp',
    sourceUrl: 'https://www.eastwestbanker.com/cards/creditcards/priority-visa-infinite',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['maybank visa infinite', 'maybank_visa_infinite'],
    assetPath: '/cards/clean/maybank_visa_infinite.webp',
    sourceUrl: 'https://www.maybankpremierwealth.com/ph/en/visa-infinite.html',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
  ...
  {
    cardKeys: ['rcbc classic jcb', 'rcbc_classic_jcb'],
    assetPath: '/cards/clean/rcbc_classic_jcb.webp',
    sourceUrl: 'https://rcbccredit.com/credit-cards/gold-and-classic-cards/classic-jcb',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['rcbc flex gold visa', 'rcbc_flex_gold_visa'],
    assetPath: '/cards/clean/rcbc_flex_gold_visa.webp',
    sourceUrl: 'https://rcbccredit.com/credit-cards/gold-and-classic-cards/flex-gold-visa',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['rcbc hexagon club priority', 'rcbc_hexagon_club_priority'],
    assetPath: '/cards/clean/rcbc_hexagon_club_priority.webp',
    sourceUrl: 'https://rcbccredit.com/hexagonpriority',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['rcbc jcb platinum', 'rcbc_jcb_platinum'],
    assetPath: '/cards/clean/rcbc_jcb_platinum.webp',
    sourceUrl: 'https://rcbccredit.com/credit-cards/premium-cards/jcb-platinum',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['rcbc landmark anson s mastercard', 'rcbc_landmark_anson_s_mastercard'],
    assetPath: '/cards/clean/rcbc_landmark_anson_s_mastercard.webp',
    sourceUrl: 'https://rcbccredit.com/credit-cards/co-branded-cards/landmark-ansons-mastercard',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['rcbc unionpay diamond card', 'rcbc_unionpay_diamond_card'],
    assetPath: '/cards/clean/rcbc_unionpay_diamond_card.webp',
    sourceUrl: 'https://rcbccredit.com/credit-cards/premium-cards/unionpay-diamond-card',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['rcbc visa infinite', 'rcbc_visa_infinite'],
    assetPath: '/cards/clean/rcbc_visa_infinite.webp',
    sourceUrl: 'https://rcbccredit.com/credit-cards/premium-cards/visa-infinite-card',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['rcbc ygc rewards plus', 'rcbc_ygc_rewards_plus'],
    assetPath: '/cards/clean/rcbc_ygc_rewards_plus.webp',
    sourceUrl: 'https://rcbccredit.com/ygcrewardsplus',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['rcbc zalora credit card', 'rcbc_zalora_credit_card'],
    assetPath: '/cards/clean/rcbc_zalora_credit_card.webp',
    sourceUrl: 'https://rcbccredit.com/zalora',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['rcbc airasia credit card', 'rcbc_airasia_credit_card'],
    assetPath: '/cards/clean/rcbc_airasia_credit_card.webp',
    sourceUrl: 'https://rcbccredit.com/airasia',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['rcbc airasia platinum credit card', 'rcbc_airasia_platinum_credit_card'],
    assetPath: '/cards/clean/rcbc_airasia_platinum_credit_card.webp',
    sourceUrl: 'https://rcbccredit.com/airasiaplatinum',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['security bank gold mastercard', 'security_bank_gold_mastercard'],
    assetPath: '/cards/clean/security_bank_gold_mastercard.webp',
    sourceUrl: 'https://www.securitybank.com/personal/credit-cards/rewards/mastercard-gold/',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['security bank world mastercard', 'security_bank_world_mastercard'],
    assetPath: '/cards/clean/security_bank_world_mastercard.webp',
    sourceUrl: 'https://www.securitybank.com/personal/credit-cards/premium-rewards/mastercard-world/',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['security bank platinum mastercard', 'security_bank_platinum_mastercard'],
    assetPath: '/cards/clean/security_bank_platinum_mastercard.webp',
    sourceUrl: 'https://www.securitybank.com/personal/credit-cards/premium-rewards/mastercard-platinum/',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['security bank cashback platinum mastercard', 'security_bank_cashback_platinum_mastercard'],
    assetPath: '/cards/clean/security_bank_cashback_platinum_mastercard.webp',
    sourceUrl: 'https://www.securitybank.com/personal/credit-cards/',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['security bank classic mastercard', 'security_bank_classic_mastercard'],
    assetPath: '/cards/clean/security_bank_classic_mastercard.webp',
    sourceUrl: 'https://www.securitybank.com/personal/credit-cards/',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['maybank gold mastercard', 'maybank_gold_mastercard'],
    assetPath: '/cards/clean/maybank_gold_mastercard.webp',
    sourceUrl: 'https://www.maybank.com.ph/en/personal/cards/credit-cards/mastercard-gold.page',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['maybank platinum mastercard', 'maybank_platinum_mastercard'],
    assetPath: '/cards/clean/maybank_platinum_mastercard.webp',
    sourceUrl: 'https://www.maybank.com.ph/en/personal/cards/credit-cards/mastercard-platinum.page',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['maybank standard mastercard', 'maybank_standard_mastercard'],
    assetPath: '/cards/clean/maybank_standard_mastercard.webp',
    sourceUrl: 'https://www.maybank.com.ph/en/personal/cards/credit-cards/mastercard-standard.page',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['maybank visa classic', 'maybank_visa_classic'],
    assetPath: '/cards/clean/maybank_visa_classic.webp',
    sourceUrl: 'https://www.maybank.com.ph/en/personal/cards/credit-cards/visa-classic.page',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['maybank visa gold', 'maybank_visa_gold'],
    assetPath: '/cards/clean/maybank_visa_gold.webp',
    sourceUrl: 'https://www.maybank.com.ph/en/personal/cards/credit-cards/visa-gold.page',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['maybank visa platinum', 'maybank_visa_platinum'],
    assetPath: '/cards/clean/maybank_visa_platinum.webp',
    sourceUrl: 'https://www.maybank.com.ph/en/personal/cards/credit-cards/visa-platinum.page',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['equicom classic credit card', 'equicom_classic_credit_card'],
    assetPath: '/cards/clean/equicom_classic_credit_card.webp',
    sourceUrl: 'https://www.equicomsavings.com/product-and-services/card-products/',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['eastwest jcb gold', 'eastwest_jcb_gold'],
    assetPath: '/cards/clean/eastwest_jcb_gold.webp',
    sourceUrl: 'https://www.eastwestbanker.com/cards/creditcards/eastwest-jcb-gold',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['eastwest jcb platinum', 'eastwest_jcb_platinum'],
    assetPath: '/cards/clean/eastwest_jcb_platinum.webp',
    sourceUrl: 'https://www.eastwestbanker.com/cards/creditcards/eastwest-jcb-platinum',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['eastwest krisflyer platinum mastercard', 'eastwest_krisflyer_platinum_mastercard'],
    assetPath: '/cards/clean/eastwest_krisflyer_platinum_mastercard.webp',
    sourceUrl: 'https://www.eastwestbanker.com/cards/creditcards/krisflyer-platinum-mastercard',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
  {
    cardKeys: ['hsbc premier mastercard', 'hsbc_premier_mastercard'],
    assetPath: '/cards/clean/hsbc_premier_mastercard.webp',
    sourceUrl: 'https://www.hsbc.com.ph/credit-cards/products/premier/',
    checkedAt: '2026-06-18',
    status: 'official-art',
  },
